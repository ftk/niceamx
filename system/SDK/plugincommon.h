...
#if defined(__linux) || defined(__linux__) || defined(linux) || defined(LINUX) || defined(FREEBSD) || defined(__FreeBSD__) || defined(__OpenBSD__)
  #ifndef __GNUC__
...
enum PLUGIN_DATA_TYPE
{
	...
	PLUGIN_DATA_CSAMP_HANDLE		= 0xE1, // void (*CSampHandle) ()
	PLUGIN_DATA_RAKNET_HANDLE		= 0xE2, // void (*RaknetHandle) ()
	PLUGIN_DATA_LOAD_FILTERSCRIPT	= 0xE3, // int (*AmxLoadFilterScript) (char *szFileName,int unknown)
	PLUGIN_DATA_CCONFIG_HANDLE		= 0xE4, // void (*CConfigHandle) ()
	PLUGIN_DATA_UNLOAD_FILTERSCRIPT	= 0xE5 // int (*AmxUnloadFilterScript) (char *szFileName)
