...
/*#ifdef _03B
    ...
    */
    ...
    int set_player_camera_look_at (int playerid, float x, float y, float z, camera_cut cut)
    {
        START();
    ...
    int interpolate_camera_pos (int playerid, float FromX, float FromY, float FromZ, float ToX, float ToY, float ToZ, int time, camera_cut cut)
    {
        START();
        cell _R; return CALL_NATIVE_R(interpolate_camera_pos,  playerid, FromX, FromY, FromZ, ToX, ToY, ToZ, time, static_cast<int>(cut));
    }
    int interpolate_camera_look_at (int playerid, float FromX, float FromY, float FromZ, float ToX, float ToY, float ToZ, int time, camera_cut cut)
    {
        START();
